        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('asset_management_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/categories*") ? "menu-open" : "" }} {{ request()->is("admin/alt-kategorilers*") ? "menu-open" : "" }} {{ request()->is("admin/stores*") ? "menu-open" : "" }} {{ request()->is("admin/asset-categories*") ? "menu-open" : "" }} {{ request()->is("admin/deliveries*") ? "menu-open" : "" }} {{ request()->is("admin/submissions*") ? "menu-open" : "" }} {{ request()->is("admin/asset-locations*") ? "menu-open" : "" }} {{ request()->is("admin/asset-statuses*") ? "menu-open" : "" }} {{ request()->is("admin/assets*") ? "menu-open" : "" }} {{ request()->is("admin/assets-histories*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle {{ request()->is("admin/categories*") ? "active" : "" }} {{ request()->is("admin/alt-kategorilers*") ? "active" : "" }} {{ request()->is("admin/stores*") ? "active" : "" }} {{ request()->is("admin/asset-categories*") ? "active" : "" }} {{ request()->is("admin/deliveries*") ? "active" : "" }} {{ request()->is("admin/submissions*") ? "active" : "" }} {{ request()->is("admin/asset-locations*") ? "active" : "" }} {{ request()->is("admin/asset-statuses*") ? "active" : "" }} {{ request()->is("admin/assets*") ? "active" : "" }} {{ request()->is("admin/assets-histories*") ? "active" : "" }}" href="#">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @endcan
                            @can('alt_kategoriler_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.alt-kategorilers.index") }}" class="nav-link {{ request()->is("admin/alt-kategorilers") || request()->is("admin/alt-kategorilers/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-cogs">
