    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.stores.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('story_county') ? 'is-invalid' : '' }}" type="text" name="story_county" id="story_county" value="{{ old('story_county', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('story_district') ? 'is-invalid' : '' }}" type="text" name="story_district" id="story_district" value="{{ old('story_district', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('story_adress') ? 'is-invalid' : '' }}" type="text" name="story_adress" id="story_adress" value="{{ old('story_adress', '') }}">
