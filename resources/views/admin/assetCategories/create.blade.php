    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.asset-categories.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('serial_number') ? 'is-invalid' : '' }}" name="serial_number" id="serial_number" required>{{ old('serial_number') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_brand') ? 'is-invalid' : '' }}" type="text" name="product_brand" id="product_brand" value="{{ old('product_brand', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_description') ? 'is-invalid' : '' }}" type="text" name="product_description" id="product_description" value="{{ old('product_description', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amountofstock') ? 'is-invalid' : '' }}" type="number" name="amountofstock" id="amountofstock" value="{{ old('amountofstock', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('minimum_stock') ? 'is-invalid' : '' }}" type="number" name="minimum_stock" id="minimum_stock" value="{{ old('minimum_stock', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('delivery_date') ? 'is-invalid' : '' }}" type="text" name="delivery_date" id="delivery_date" value="{{ old('delivery_date') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status" required>
                    ...
                    @foreach(App\Models\AssetCategory::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', 'Durum Seçiniz') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
