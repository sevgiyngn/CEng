    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-productsDeliveries">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($deliveries as $key => $delivery)
                            <tr data-entry-id="{{ $delivery->id }}">
                                ...
                                <td>
                                    @foreach($delivery->products as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-productsDeliveries:not(.ajaxTable)').DataTable({ buttons: dtButtons })
